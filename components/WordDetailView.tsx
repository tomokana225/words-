          ...
          <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-slate-100 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-2">
                <span className="inline-block px-3 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-black uppercase tracking-widest rounded-full border border-indigo-100 mb-2">
                  {word.level}
                </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <section className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm space-y-4 md:col-span-2">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-xs font-black text-slate-800 uppercase tracking-widest">単語の成り立ち・コアイメージ</h3>
                </div>
              ...
              <section className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm space-y-4 md:col-span-2">
                ...
                <div className="p-6 bg-emerald-50/50 rounded-2xl border border-emerald-100 space-y-3 relative group">
                  ...
                  <button 
                    ...
                    className="absolute top-4 right-4 w-8 h-8 rounded-full bg-white text-emerald-600 flex items-center justify-center shadow-sm hover:scale-110 transition"
                  >
